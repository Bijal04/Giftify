...
<html>
   ...
   <body>
    ...
    <div class="slider fullscreen slider_adjust">
        <ul class="slides">
          <li>
            <img src="img/home_page.jpg"> <!-- random image -->
            <div class="caption left-align">
              <h4 class="white-text">Welcome To The Giftify!</h4>
            </div>
          </li>
          <li>
            <img src="img/maximum1.jpg"> <!-- random image -->
            <div class="caption left-align">
              <h3 class="black-text">Get Maximum Opportunities!</h3>
            </div>
          </li>
          <li>
            <img src="img/delivery.jpg"> <!-- random image -->
            <div class="caption left-align">
    ...
    This is giftstore. Welcome to our store. Maximum opportunites are offered on our website. Kindly look at our collection and order maximum products from our site.Safe banking and product tracking is also our feature.
 ...
 <section>
     <section class="container section" id="photo's">
      <div class="row">
        <div class="col s12 l4">
          <img src="img/combo.jpg" class="responsive-img">
        </div>
        <div class="col s12 l6">
          <h3 class="red-text text-accent-3">Amazing Gifts</h3>
          <p>Combo Gift</p>
        </div>
      </div>
      <div class="row">
        <div class="col s12 l4">
          <img src="img/hamper.jpg" class="responsive-img">
        </div>
        <div class="col s12 l6">
          <h3 class="red-text text-accent-3">Amazing Gifts</h3>
          <p>Gift Hamper</p>
      ...
      <div class="row">
        <div class="col s12 l4">
          <img src="img/customized.jpg" class="responsive-img">
        </div>
        <div class="col s12 l6">
          <h3 class="red-text text-accent-3">Amazing Gifts</h3>
          <p>customize with Giftify</p>
        </div>
      </div>
    </section>
    <!--parallax-->
      ...
      <div class="parallax-container" style="height:100%;">
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-1" data-as="true"  data-as-animation="anime-end-1" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="img/soft_toy.jpg">
              </div>
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-2" data-as="true"  data-as-animation="anime-end-2" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="img/Crockery.jpg">
              </div>
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-3" data-as="true"  data-as-animation="anime-end-3" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="img/Jewellery.jpg">
              </div>
              <a href="#">
                <div class="card-action center-align black white-text flow-text">
                  Jewellery
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-4" data-as="true"  data-as-animation="anime-end-4" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="img/Wallets.jpg">
              </div>
              <a href="#">
                <div class="card-action center-align black white-text flow-text">
                  Wallets
    ...
    <div class="col s12 l4">
          <img src="img/find.png" class="responsive-img">
        </div>
    <h5>Can’t find the perfect gift of your choice? Our AI-powered tool will guide you in choosing the perfect gift.Click here...</h5>
    <li><a href="AI.php" class="side_nav"><h4 class="red-text">Gift Finder</h4></a></li>
      <!-- Page Footer -->
